...
export default function SidePanel() {
  return (
    <div className="flex flex-col p-4 space-y-2">
        ...
        <Link href ="/dashboard/movies" className="hover:bg-blue-50 text-sm p-2 rounded" >Movies</Link>
        <Link href ="/dashboard/add_movie" className="hover:bg-blue-50 text-sm p-2 rounded" >Add Movies</Link>
